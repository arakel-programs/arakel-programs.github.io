...
function winner({ player, enemy, timerID }) {
    ...
    if (auxWinner === false) {
        if (player.health === enemy.health) {
            document.querySelector('.c-timer').innerHTML = 'A TIE';
            ...
            document.querySelector('.c-timer').innerHTML = 'Player One Won';
            buttonsFinish.style.display = 'flex';
            buttonsFinish.style.background = '#00000047';
            auxWinner = true;
            blockControlE = true;
        } else if (enemy.health > player.health) {
            document.querySelector('.c-timer').innerHTML = 'Player Two Won';
            buttonsFinish.style.display = 'flex';
            buttonsFinish.style.background = '#00000047';
            auxWinner = true;
            blockControlP = true;
