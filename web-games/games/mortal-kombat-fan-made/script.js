...
var sonya = {
  name: "sonya",
  soundName: new Audio('audio/names/sonya.mp3'),
  soundRun: new Audio('audio/syborg_run.mp3'),
  previewImgIcon: "img/players-list/sonya.gif",
  previewImg: "img/players-list/versus/sonya.png",
}
...
function jump(player){
  ...
  function toTop(callbackFn){
    ...
    setTimeout(function() {
      player.playerSelector.style.bottom = parseInt(player.playerSelector.style.bottom) + 4 + 'px';
...
function roundCountFunc(){
  ...
  if (gameData.currentRound === 1) {
    ...
    roundMessages("Round " + gameData.currentRound, 4000);
  }
